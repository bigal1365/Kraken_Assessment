...
/bin/rm -f ${T_DIR}/Kraken-plan.jtl ${T_DIR}/jmeter.log  > /dev/null 2>&1

./run.sh -Dlog_level.jmeter=DEBUG \
	-n -t ${T_DIR}/Kraken_take_home.jmx -l ${T_DIR}/Kraken-plan.jtl -j ${T_DIR}/jmeter.log \
	-e -o ${R_DIR}
